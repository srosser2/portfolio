...
const Derive = ({ onContactClick, contactRef }) => {
  ...
  return (
    <Section>
      ...
      <Button clickHandler={() => window.open('https://github.com/srosser2/GA03-Derive', '_blank')} type={'secondary'}><span className={'icon-github-circle'} style={{ fontSize: '32px'}}></span> GitHub</Button>
