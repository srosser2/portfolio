...
const Derive = ({ onContactClick, contactRef }) => {
  ...
  return (
    <Section>
      ...
      <p>While we wait for Dérive to become a mainstream, I created a number of random characters to get the ball rolling. The colourful characters you see on the app were generated using the npm <a href='https://www.npmjs.com/package/faker' target='_blank'>Faker</a> package combined with the <a href='https://getavataaars.com/' target='_blank'>Avataaars Generator</a>. The result is a diverse set of nonsense characters who have shared their reviews of countries across the globe.</p>
